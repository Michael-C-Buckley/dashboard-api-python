...
class AsyncNetworks:
    ...
    def getNetwork(self, networkId: str):
        ...
        **Return a network**
        ...
        resource = f'/networks/{prepare(networkId)}'
    ...
    def getNetworkAlertsHistory(self, networkId: str, total_pages=1, direction='next', **kwargs):
        ...
        **Return the alert history for this network**
        ...
        resource = f'/networks/{prepare(networkId)}/alerts/history'
    ...
    def getNetworkAlertsSettings(self, networkId: str):
        ...
        **Return the alert configuration for this network**
        ...
        resource = f'/networks/{prepare(networkId)}/alerts/settings'
    ...
    def bindNetwork(self, networkId: str, configTemplateId: str, **kwargs):
        ...
        **Bind a network to a template.**
        ...
        resource = f'/networks/{prepare(networkId)}/bind'
    ...
    def getNetworkBluetoothClients(self, networkId: str, total_pages=1, direction='next', **kwargs):
        ...
        **List the Bluetooth clients seen by APs in this network**
        ...
        resource = f'/networks/{prepare(networkId)}/bluetoothClients'
    ...
    def getNetworkBluetoothClient(self, networkId: str, bluetoothClientId: str, **kwargs):
        ...
        **Return a Bluetooth client**
        ...
        resource = f'/networks/{prepare(networkId)}/bluetoothClients/{prepare(bluetoothClientId)}'
    ...
    def getNetworkClients(self, networkId: str, total_pages=1, direction='next', **kwargs):
        ...
        **List the clients that have used this network in the timespan**
        ...
        resource = f'/networks/{prepare(networkId)}/clients'
    ...
    def getNetworkClientsApplicationUsage(self, networkId: str, clients: str, total_pages=1, direction='next', **kwargs):
        ...
        **Return the application usage data for clients**
        ...
        resource = f'/networks/{prepare(networkId)}/clients/applicationUsage'
    ...
    def getNetworkClientsBandwidthUsageHistory(self, networkId: str, total_pages=1, direction='next', **kwargs):
        ...
        **Returns a timeseries of total traffic consumption rates for all clients on a network within a given timespan, in megabits per second.**
        ...
        resource = f'/networks/{prepare(networkId)}/clients/bandwidthUsageHistory'
    ...
    def getNetworkClientsOverview(self, networkId: str, **kwargs):
        ...
        **Return overview statistics for network clients**
        ...
        resource = f'/networks/{prepare(networkId)}/clients/overview'
    ...
    def provisionNetworkClients(self, networkId: str, clients: list, devicePolicy: str, **kwargs):
        ...
        **Provisions a client with a name and policy**
        ...
        resource = f'/networks/{prepare(networkId)}/clients/provision'
    ...
    def getNetworkClientsUsageHistories(self, networkId: str, clients: str, total_pages=1, direction='next', **kwargs):
        ...
        **Return the usage histories for clients**
        ...
        resource = f'/networks/{prepare(networkId)}/clients/usageHistories'
    ...
    def getNetworkClient(self, networkId: str, clientId: str):
        ...
        **Return the client associated with the given identifier**
        ...
        resource = f'/networks/{prepare(networkId)}/clients/{prepare(clientId)}'
    ...
    def getNetworkClientPolicy(self, networkId: str, clientId: str):
        ...
        **Return the policy assigned to a client on the network**
        ...
        resource = f'/networks/{prepare(networkId)}/clients/{prepare(clientId)}/policy'
    ...
    def getNetworkClientSplashAuthorizationStatus(self, networkId: str, clientId: str):
        ...
        **Return the splash authorization for a client, for each SSID they've associated with through splash**
        ...
        resource = f'/networks/{prepare(networkId)}/clients/{prepare(clientId)}/splashAuthorizationStatus'
    ...
    def getNetworkClientTrafficHistory(self, networkId: str, clientId: str, total_pages=1, direction='next', **kwargs):
        ...
        **Return the client's network traffic data over time**
        ...
        resource = f'/networks/{prepare(networkId)}/clients/{prepare(clientId)}/trafficHistory'
    ...
    def getNetworkClientUsageHistory(self, networkId: str, clientId: str):
        ...
        **Return the client's daily usage history**
        ...
        resource = f'/networks/{prepare(networkId)}/clients/{prepare(clientId)}/usageHistory'
    ...
    def getNetworkDevices(self, networkId: str):
        ...
        **List the devices in a network**
        ...
        resource = f'/networks/{prepare(networkId)}/devices'
    ...
    def claimNetworkDevices(self, networkId: str, serials: list):
        ...
        **Claim devices into a network. (Note: for recently claimed devices, it may take a few minutes for API requsts against that device to succeed)**
        ...
        resource = f'/networks/{prepare(networkId)}/devices/claim'
    ...
    def vmxNetworkDevicesClaim(self, networkId: str, size: str):
        ...
        **Claim a vMX into a network**
        ...
        resource = f'/networks/{prepare(networkId)}/devices/claim/vmx'
    ...
    def removeNetworkDevices(self, networkId: str, serial: str):
        ...
        **Remove a single device**
        ...
        resource = f'/networks/{prepare(networkId)}/devices/remove'
    ...
    def getNetworkEvents(self, networkId: str, total_pages=1, direction='prev', event_log_end_time=None, **kwargs):
        ...
        **List the events for the network**
        ...
        resource = f'/networks/{prepare(networkId)}/events'
    ...
    def getNetworkEventsEventTypes(self, networkId: str):
        ...
        **List the event type to human-readable description**
        ...
        resource = f'/networks/{prepare(networkId)}/events/eventTypes'
    ...
    def getNetworkFirmwareUpgrades(self, networkId: str):
        ...
        **Get firmware upgrade information for a network**
        ...
        resource = f'/networks/{prepare(networkId)}/firmwareUpgrades'
    ...
    def createNetworkFirmwareUpgradesRollback(self, networkId: str, reasons: list, **kwargs):
        ...
        **Rollback a Firmware Upgrade For A Network**
        ...
        resource = f'/networks/{prepare(networkId)}/firmwareUpgrades/rollbacks'
    ...
    def getNetworkFirmwareUpgradesStagedEvents(self, networkId: str):
        ...
        **Get the Staged Upgrade Event from a network**
        ...
        resource = f'/networks/{prepare(networkId)}/firmwareUpgrades/staged/events'
    ...
    def deferNetworkFirmwareUpgradesStagedEvents(self, networkId: str):
        ...
        **Postpone by 1 week all pending staged upgrade stages for a network**
        ...
        resource = f'/networks/{prepare(networkId)}/firmwareUpgrades/staged/events/defer'
    ...
    def rollbacksNetworkFirmwareUpgradesStagedEvents(self, networkId: str, stages: list, **kwargs):
        ...
        **Rollback a Staged Upgrade Event for a network**
        ...
        resource = f'/networks/{prepare(networkId)}/firmwareUpgrades/staged/events/rollbacks'
    ...
    def getNetworkFirmwareUpgradesStagedGroups(self, networkId: str):
        ...
        **List of Staged Upgrade Groups in a network**
        ...
        resource = f'/networks/{prepare(networkId)}/firmwareUpgrades/staged/groups'
    ...
    def getNetworkFirmwareUpgradesStagedGroup(self, networkId: str, groupId: str):
        ...
        **Get a Staged Upgrade Group from a network**
        ...
        resource = f'/networks/{prepare(networkId)}/firmwareUpgrades/staged/groups/{prepare(groupId)}'
    ...
    def getNetworkFirmwareUpgradesStagedStages(self, networkId: str):
        ...
        **Order of Staged Upgrade Groups in a network**
        ...
        resource = f'/networks/{prepare(networkId)}/firmwareUpgrades/staged/stages'
    ...
    def getNetworkFloorPlans(self, networkId: str):
        ...
        **List the floor plans that belong to your network**
        ...
        resource = f'/networks/{prepare(networkId)}/floorPlans'
    ...
    def getNetworkFloorPlan(self, networkId: str, floorPlanId: str):
        ...
        **Find a floor plan by ID**
        ...
        resource = f'/networks/{prepare(networkId)}/floorPlans/{prepare(floorPlanId)}'
    ...
    def getNetworkGroupPolicies(self, networkId: str):
        ...
        **List the group policies in a network**
        ...
        resource = f'/networks/{prepare(networkId)}/groupPolicies'
    ...
    def getNetworkGroupPolicy(self, networkId: str, groupPolicyId: str):
        ...
        **Display a group policy**
        ...
        resource = f'/networks/{prepare(networkId)}/groupPolicies/{prepare(groupPolicyId)}'
    ...
    def getNetworkHealthAlerts(self, networkId: str):
        ...
        **Return all global alerts on this network**
        ...
        resource = f'/networks/{prepare(networkId)}/health/alerts'
    ...
    def getNetworkMerakiAuthUsers(self, networkId: str):
        ...
        **List the users configured under Meraki Authentication for a network (splash guest or RADIUS users for a wireless network, or client VPN users for a MX network)**
        ...
        resource = f'/networks/{prepare(networkId)}/merakiAuthUsers'
    ...
    def getNetworkMerakiAuthUser(self, networkId: str, merakiAuthUserId: str):
        ...
        **Return the Meraki Auth splash guest, RADIUS, or client VPN user**
        ...
        resource = f'/networks/{prepare(networkId)}/merakiAuthUsers/{prepare(merakiAuthUserId)}'
    ...
    def getNetworkMqttBrokers(self, networkId: str):
        ...
        **List the MQTT brokers for this network**
        ...
        resource = f'/networks/{prepare(networkId)}/mqttBrokers'
    ...
    def getNetworkMqttBroker(self, networkId: str, mqttBrokerId: str):
        ...
        **Return an MQTT broker**
        ...
        resource = f'/networks/{prepare(networkId)}/mqttBrokers/{prepare(mqttBrokerId)}'
    ...
    def getNetworkNetflow(self, networkId: str):
        ...
        **Return the NetFlow traffic reporting settings for a network**
        ...
        resource = f'/networks/{prepare(networkId)}/netflow'
    ...
    def getNetworkNetworkHealthChannelUtilization(self, networkId: str, total_pages=1, direction='next', **kwargs):
        ...
        **Get the channel utilization over each radio for all APs in a network.**
        ...
        resource = f'/networks/{prepare(networkId)}/networkHealth/channelUtilization'
    ...
    def getNetworkPiiPiiKeys(self, networkId: str, **kwargs):
        ...
        **List the keys required to access Personally Identifiable Information (PII) for a given identifier**
        ...
        resource = f'/networks/{prepare(networkId)}/pii/piiKeys'
    ...
    def getNetworkPiiRequests(self, networkId: str):
        ...
        **List the PII requests for this network or organization**
        ...
        resource = f'/networks/{prepare(networkId)}/pii/requests'
    ...
    def getNetworkPiiSmDevicesForKey(self, networkId: str, **kwargs):
        ...
        **Given a piece of Personally Identifiable Information (PII), return the Systems Manager device ID(s) associated with that identifier**
        ...
        resource = f'/networks/{prepare(networkId)}/pii/smDevicesForKey'
    ...
    def getNetworkPiiSmOwnersForKey(self, networkId: str, **kwargs):
        ...
        **Given a piece of Personally Identifiable Information (PII), return the Systems Manager owner ID(s) associated with that identifier**
        ...
        resource = f'/networks/{prepare(networkId)}/pii/smOwnersForKey'
    ...
    def getNetworkPoliciesByClient(self, networkId: str, total_pages=1, direction='next', **kwargs):
        ...
        **Get policies for all clients with policies**
        ...
        resource = f'/networks/{prepare(networkId)}/policies/byClient'
    ...
    def getNetworkSettings(self, networkId: str):
        ...
        **Return the settings for a network**
        ...
        resource = f'/networks/{prepare(networkId)}/settings'
    ...
    def getNetworkSnmp(self, networkId: str):
        ...
        **Return the SNMP settings for a network**
        ...
        resource = f'/networks/{prepare(networkId)}/snmp'
    ...
    def getNetworkSplashLoginAttempts(self, networkId: str, **kwargs):
        ...
        **List the splash login attempts for a network**
        ...
        resource = f'/networks/{prepare(networkId)}/splashLoginAttempts'
    ...
    def splitNetwork(self, networkId: str):
        ...
        **Split a combined network into individual networks for each type of device**
        ...
        resource = f'/networks/{prepare(networkId)}/split'
    ...
    def getNetworkSyslogServers(self, networkId: str):
        ...
        **List the syslog servers for a network**
        ...
        resource = f'/networks/{prepare(networkId)}/syslogServers'
    ...
    def getNetworkTopologyLinkLayer(self, networkId: str):
        ...
        **List the LLDP and CDP information for all discovered devices and connections in a network**
        ...
        resource = f'/networks/{prepare(networkId)}/topology/linkLayer'
    ...
    def getNetworkTraffic(self, networkId: str, **kwargs):
        ...
        **Return the traffic analysis data for this network**
        ...
        resource = f'/networks/{prepare(networkId)}/traffic'
    ...
    def getNetworkTrafficAnalysis(self, networkId: str):
        ...
        **Return the traffic analysis settings for a network**
        ...
        resource = f'/networks/{prepare(networkId)}/trafficAnalysis'
    ...
    def getNetworkTrafficShapingApplicationCategories(self, networkId: str):
        ...
        **Returns the application categories for traffic shaping rules**
        ...
        resource = f'/networks/{prepare(networkId)}/trafficShaping/applicationCategories'
    ...
    def getNetworkTrafficShapingDscpTaggingOptions(self, networkId: str):
        ...
        **Returns the available DSCP tagging options for your traffic shaping rules.**
        ...
        resource = f'/networks/{prepare(networkId)}/trafficShaping/dscpTaggingOptions'
    ...
    def unbindNetwork(self, networkId: str, **kwargs):
        ...
        **Unbind a network from a template.**
        ...
        resource = f'/networks/{prepare(networkId)}/unbind'
    ...
    def getNetworkVlanProfiles(self, networkId: str):
        ...
        **List VLAN profiles for a network**
        ...
        resource = f'/networks/{prepare(networkId)}/vlanProfiles'
    ...
    def getNetworkVlanProfilesAssignmentsByDevice(self, networkId: str, total_pages=1, direction='next', **kwargs):
        ...
        **Get the assigned VLAN Profiles for devices in a network**
        ...
        resource = f'/networks/{prepare(networkId)}/vlanProfiles/assignments/byDevice'
    ...
    def reassignNetworkVlanProfilesAssignments(self, networkId: str, serials: list, stackIds: list, **kwargs):
        ...
        **Update the assigned VLAN Profile for devices in a network**
        ...
        resource = f'/networks/{prepare(networkId)}/vlanProfiles/assignments/reassign'
    ...
    def getNetworkWebhooksHttpServers(self, networkId: str):
        ...
        **List the HTTP servers for a network**
        ...
        resource = f'/networks/{prepare(networkId)}/webhooks/httpServers'
    ...
    def getNetworkWebhooksHttpServer(self, networkId: str, httpServerId: str):
        ...
        **Return an HTTP server for a network**
        ...
        resource = f'/networks/{prepare(networkId)}/webhooks/httpServers/{prepare(httpServerId)}'
    ...
    def getNetworkWebhooksPayloadTemplates(self, networkId: str):
        ...
        **List the webhook payload templates for a network**
        ...
        resource = f'/networks/{prepare(networkId)}/webhooks/payloadTemplates'
    ...
    def getNetworkWebhooksPayloadTemplate(self, networkId: str, payloadTemplateId: str):
        ...
        **Get the webhook payload template for a network**
        ...
        resource = f'/networks/{prepare(networkId)}/webhooks/payloadTemplates/{prepare(payloadTemplateId)}'
    ...
    def createNetworkWebhooksWebhookTest(self, networkId: str, url: str, **kwargs):
        ...
        **Send a test webhook for a network**
        ...
        resource = f'/networks/{prepare(networkId)}/webhooks/webhookTests'
    ...
    def getNetworkWebhooksWebhookTest(self, networkId: str, webhookTestId: str):
        ...
        **Return the status of a webhook test for a network**
        ...
        resource = f'/networks/{prepare(networkId)}/webhooks/webhookTests/{prepare(webhookTestId)}'
